...
function calculate() {
  ...
  var row0 = ['Price Per Box',             fmt(retailPerBox),               fmt(compPerBox)];
  var row1 = ['Boxes (per eye)',            String(boxes),                   String(boxes)];
  var row2 = ['Eyes',                       String(eyes),                    String(eyes)];
  var row3 = ['Gross Total',               fmt(ourGross),                   fmt(compGross)];
  var row4 = ['Rebate Applied',
               rebate     > 0 ? '-' + fmt(rebate)     : '-',
               compRebate > 0 ? '-' + fmt(compRebate) : '-'];
  var row5 = ['<strong>Net Total</strong>',
  ...
  for (var i = 0; i < rows.length; i++) {
    var r = rows[i];
    tbodyHtml += '<tr>';
    tbodyHtml += '<td>'                  + r<a href="" class="citation-link" target="_blank" style="vertical-align: super; font-size: 0.8em; margin-left: 3px;">[0]</a> + '</td>';
    tbodyHtml += '<td class="col-ours">' + r<a href="" class="citation-link" target="_blank" style="vertical-align: super; font-size: 0.8em; margin-left: 3px;">[1]</a> + '</td>';
    tbodyHtml += '<td class="col-comp">' + r<a href="" class="citation-link" target="_blank" style="vertical-align: super; font-size: 0.8em; margin-left: 3px;">[2]</a> + '</td>';
    tbodyHtml += '</tr>';
  }
